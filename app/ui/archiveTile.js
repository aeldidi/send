  ...
  return html`
    ...
    >
      ${list(
        ...
        'flex-shrink bg-pastel-green rounded-t overflow-y-auto px-6 py-4 md:h-full md:max-h-half-screen dark:bg-black',
        'bg-white px-2 my-2 shadow-light rounded dark:bg-grey-90 dark:border dark:border-grey-80'
      )}
      <div
        class="flex-shrink-0 flex-grow flex items-end p-4 bg-pastel-green rounded-b mb-1 font-medium dark:bg-grey-90"
      >
        <input
          id="file-upload"
